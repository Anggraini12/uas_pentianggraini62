...
if($cek_pass1 == 0){
    #eror password lama tidak sesuai
    $pesan = '<div class="alert alert-danger" role="alert">
            <i class="fa-solid fa-triangle-exclamation"></i> Password Lama Tidak Sesuai!!!
            </div>';
}elseif($pass2 != $pass3){
    #eror password baru dan konf,password baru tidak sesuai
    $pesan = '<div class="alert alert-danger" role="alert">
            <i class="fa-solid fa-triangle-exclamation"></i> Password Baru Untuk Konfirmasi Password Tidak Sesuai!!!
            </div>';
}else{
