...
if(isset($_POST['tombol'])){
    ...
    if($cek > 0){
    //login berhasil
    #(OPTIONAL) 4.1 mengambil data lainnya dari table user berdasarkan data login
    ...
    #pembuatan Cookie
    if($_POST['cek'] == "yes"){
    setcookie("cid",$id_login,time()+(60*60*24*30*90),"/");
    setcookie("cemail",$email,time()+(60*60*24*30*90),"/");
    setcookie("cnama",$nama_login,time()+(60*60*24*30*90),"/");
    }
